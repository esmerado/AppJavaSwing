 ...
 * @author esmer
 */
public class LionFR extends javax.swing.JDialog {

    /**
     * Creates new form LionESP
     */
    public LionFR(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        LionTitle.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.LionTitle.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.jLabel1.text")); // NOI18N
        ...
        Food.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.Food.text")); // NOI18N

        steakOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/steak.png"))); // NOI18N
        steakOne.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.steakOne.text")); // NOI18N

        steakTwo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/steak.png"))); // NOI18N
        steakTwo.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.steakTwo.text")); // NOI18N

        habitat.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        habitat.setForeground(new java.awt.Color(101, 34, 38));
        habitat.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.habitat.text")); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/africa.png"))); // NOI18N
        jLabel2.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.jLabel2.text")); // NOI18N

        Food1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        Food1.setForeground(new java.awt.Color(101, 34, 38));
        Food1.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.Food1.text")); // NOI18N

        btnLion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnLion.png"))); // NOI18N
        btnLion.setText(org.openide.util.NbBundle.getMessage(LionFR.class, "LionFR.btnLion.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LionFR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
