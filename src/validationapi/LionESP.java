 ...
 * @author esmer
 */
public class LionESP extends javax.swing.JDialog {

    /**
     * Creates new form LionESP
     */
    public LionESP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        LionTitle.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.LionTitle.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.jLabel1.text")); // NOI18N
        ...
        Food.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.Food.text")); // NOI18N

        steakOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/steak.png"))); // NOI18N
        steakOne.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.steakOne.text")); // NOI18N

        steakTwo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/steak.png"))); // NOI18N
        steakTwo.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.steakTwo.text")); // NOI18N

        habitat.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        habitat.setForeground(new java.awt.Color(101, 34, 38));
        habitat.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.habitat.text")); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/africa.png"))); // NOI18N
        jLabel2.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.jLabel2.text")); // NOI18N

        Food1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        Food1.setForeground(new java.awt.Color(101, 34, 38));
        Food1.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.Food1.text")); // NOI18N

        btnLion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnLion.png"))); // NOI18N
        btnLion.setText(org.openide.util.NbBundle.getMessage(LionESP.class, "LionESP.btnLion.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LionESP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
