 ...
 * @author esmer
 */
public class LionGER extends javax.swing.JDialog {

    /**
     * Creates new form LionESP
     */
    public LionGER(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        LionTitle.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.LionTitle.text")); // NOI18N
        jPanel2.add(LionTitle);

        jPanel3.setBackground(new java.awt.Color(248, 215, 177));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/lionbg.jpg"))); // NOI18N
        jLabel1.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.jLabel1.text")); // NOI18N
        ...
        Food.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.Food.text")); // NOI18N

        steakOne.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/steak.png"))); // NOI18N
        steakOne.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.steakOne.text")); // NOI18N

        steakTwo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/steak.png"))); // NOI18N
        steakTwo.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.steakTwo.text")); // NOI18N

        habitat.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        habitat.setForeground(new java.awt.Color(101, 34, 38));
        habitat.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.habitat.text")); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/africa.png"))); // NOI18N
        jLabel2.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.jLabel2.text")); // NOI18N

        Food1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        Food1.setForeground(new java.awt.Color(101, 34, 38));
        Food1.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.Food1.text")); // NOI18N

        btnLion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/btnLion.png"))); // NOI18N
        btnLion.setText(org.openide.util.NbBundle.getMessage(LionGER.class, "LionGER.btnLion.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LionGER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
